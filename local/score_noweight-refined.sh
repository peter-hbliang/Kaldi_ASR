...
if [ $stage -le 0 ]; then
  ...
  for wip in $(echo $word_ins_penalty | sed 's/,/ /g'); do
    ...
    for lmwt in $(seq $min_lmwt $max_lmwt); do
      cp $dir/scoring_kaldi/penalty_$wip/${lmwt}.txt $dir/scoring_kaldi/penalty_$wip/${lmwt}-old.txt
      sed -i 's/_ /_/g' $dir/scoring_kaldi/penalty_$wip/${lmwt}.txt
      python3 /home/nctu/LM_preprocess/compute_wer_NER/combine_2.py $dir/scoring_kaldi/penalty_$wip/${lmwt}.txt
    done
